...
# Customize a Dynamic web application with JavaScript Solution

Learn how to build and deploy your own proof of concept based on the deployed [Dynamic web application with JavaScript](https://console.cloud.google.com/products/solutions/details/dynamic-web-app-with-javascript) Jump Start Solution. You can customize the Jump Start Solution deployment by creating a copy of the source code. You can modify the infrastructure and application code as needed and redeploy the solution with the changes.
...
We also strongly recommend that you familiarize yourself with the Dynamic web application with JavaScript by reading the [solution guide](https://cloud.google.com/architecture/big-data-analytics/dynamic-web-app-with-javascript).
